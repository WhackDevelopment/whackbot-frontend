...
import { FaGithub, FaDiscord, FaPaypal, FaGlobe } from 'react-icons/fa';
    ...
    return (
        <div className="flex flex-col flex-wrap justify-start items-center bg-black border-b-2 border-black dark:border-purple-500 shadow-md shadow-black dark:shadow-purple-500">
            <nav class="bg-white dark:bg-black w-screen border-b-1 border-black dark:border-purple-500 shadow shadow-black dark:shadow-purple-500">
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <a href="/" class="flex items-center">
                        ...
                        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">WhackBot</span>
                    </a>
            ...
            <div className="flex flex-row flex-wrap justify-around items-center w-screen h-[50vh]">
                ...
                <div className="flex flex-col flex-wrap justify-center items-center min-w-[50vw]">
                    <div className="btns flex flex-row flex-wrap justify-around items-center my-2">
                        <a
                            role="button"
                            href="https://discord.com/api/oauth2/authorize?client_id=1091567706064556052&permissions=8&scope=bot%20applications.commands"
                            target="_blank"
                        ...
                        >
                            <FaDiscord className="center mr-2" /> Invite to Discord
                        </a>
                        <a
                            role="button"
                            href="https://whackdevelopment.com"
                            target="_blank"
                            rel="noopener noreferrer"
                            class="flex flex-row flex-wrap justify-center items-center text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"
                        >
                            <FaGlobe className="center mr-2" /> WhackDevelopment
                        </a>
                    </div>
                    <div className="btns flex flex-row flex-wrap justify-around items-center my-2">
                        <a
                            role="button"
                            href="https://github.com/WhackDevelopment/WhackBot"
                            target="_blank"
                            rel="noopener noreferrer"
                            class="flex flex-row flex-wrap justify-center items-center text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"
                        >
                            <FaGithub className="center mr-2" /> GitHub Repo
                        </a>
                        <a
                            role="button"
